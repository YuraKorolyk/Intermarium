...
const Page = () => {
  ...
  return (
    <>
      <Head>
        <title>{t('practices.extensionOfStayInUkraine.pageTitle')}</title>
      </Head>
      ...
      <div className={classes.application}>
        <Container className={classes.wrapper}>
          ...
          <div className={classes.button}>
            <Button text={t('practices.extensionOfStayInUkraine.application.button')} onClick={()=>setIsOpened(prevState => !prevState)} />
