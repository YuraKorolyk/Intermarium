...
const Page = () => {
  ...
  return (
    <>
      <Head>
        <title>{t('practices.registrationAsCitizenOfUkraine.pageTitle')}</title>
      </Head>
      ...
      <div className={classes.application}>
        <Container className={classes.wrapper}>
          ...
          <div className={classes.button}>
            <Button text={t('practices.registrationAsCitizenOfUkraine.application.button')} onClick={()=>setIsOpened(prevState => !prevState)} />
