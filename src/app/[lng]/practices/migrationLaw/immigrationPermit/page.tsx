...
const Page = () => {
  ...
  return (
    <>
      <Head>
        <title>{t('practices.immigrationPermit.pageTitle')}</title>
      </Head>
      ...
      <div className={classes.application}>
        <Container className={classes.wrapper}>
          ...
          <div className={classes.button}>
            <Button text={t('practices.immigrationPermit.application.button')} onClick={()=>setIsOpened(prevState => !prevState)} />
