            ...
            <Partner
              ...
              description={
                <>Юрій завдяки своєму досвіду в правових та міграційних питаннях та ефективній
                  ...
                  експертом в проведенні <span className='highlightDark'>due diligence об&apos;єкту інвестування</span> та є відповідальним за комунікацію з
                  корпоративними клієнтами, що укладають з <span className='highlightDark'>Intermarium Law Firm</span> договори про абонентське обслуговування.
                </>
              }
            />
          </div>
