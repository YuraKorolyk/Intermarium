        ...
        <Container className={classes.wrapper}>
          <div className={classes.gridBox}>
            ...
            <div className={classes.description}>
              ...
              спеціалістів в галузі міжнародного та міграційного права — <span className="highlightDark">Тараса Горбатюка</span> та <span
          ...
          <div className={classes.text}>
            ...
            <div className={classes.support}>
              ...
              <ul className={classes.list}>
                ...
                <li>інвестування</li>
                <li>також надає юридичні консультації іноземцям з різноманітних питань, з якими вони стикаються на
                  території України
                </li>
              </ul>
            </div>
        ...
        <Container className={classes.wrapper}>
          ...
          <div className={classes.text}>
            <div className={classes.first}>
              ...
              регіональному. Intermarium - <span className="highlightLight">простір країн у Центральній та Східній Європі</span>,
        ...
        <Container className={classes.wrapper}>
          ...
          <div className={classes.partnerBox}>
            ...
            <Partner
              ...
              description={
                <>Юрій – експерт з міграційного, корпоративного права та візової підтримки, ідейний натхненник створення
                  Intermarium Law Firm, та завдяки своєму досвіду в правових та міграційних питаннях та ефективній
                  ...
                  експертом в проведенні due diligence об&apos;єкту інвестування та є відповідальним за комунікацію з
                  корпоративними клієнтами, що укладають з Intermarium Law Firm договори про абонентське обслуговування.
                </>
              }
            />
          </div>
