                ...
                <Container className={classes.wrapper}>
                    ...
                    <div className={classes.partnerBox}>
                        <Partner
                            ...
                            description={["Тарас має ", <span className='highlightDark'>багаторічний досвід роботи у сфері міграційного та корпоративного права</span>,
                                " та спеціалізується на вирішенні складних кейсів, допомагає нашим клієнтам в оформлення усі необхідних документів для легального перебування іноземців на території України, а також допомагає іноземцям з питань оформлення громадянства, інвестування в економіку України, легального працевлаштування та консультує іноземців з усіх питань що стосується імміграції в Україну.",
                                <br/>,<br/>,
                                "У галузі корпоративного права, Тарас надає юридичні консультації з питань створення та реєстрації компаній, купівлі-продажу бізнесу, розподілу акцій та інших питань, пов'язаних з корпоративними структурами. ", <span className='highlightDark'>Його експертний досвід в Intermarium Law Firm гарантує комфортність, легальність та юридичну захищеність іноземних інвесторів</span>, ", що бачать своє майбутнє з Україною та з усім регіоном між Чорним, Балтійським та Адріатичним морями."
                            ]}
                        />
                        <Partner
                            name="Yurii"
                            ...
                            description={["Юрій - експерт з міграційного, корпоративного права та візової підтримки, ідейний натхненник створення Intermarium Law Firm, та завдяки своєму досвіду в правових та міграційних питаннях та ефективній комунікації в середовищі іноземців в Україні та міжнародного бізнесу може знаходити оптимальні рішення для тих, хто бажає мігрувати або започаткувати бізнес на території України та усього регіону Інтермаріуму.",
                            <br/>,<br/>,
                            "Юрій забезпечує якісне надання послуг для іноземних громадян та підбирає оптимальні рішення для інвесторів, орієнтуючись у своїй роботі на законодавчі норми та розуміння потреб клієнтів. Юрій є експертом в проведенні due diligence об’єкту інвестування та є відповідальним за комунікацію з корпоративними клієнтами, що укладають з Intermarium Law Firm договори про абонентське обслуговування."
                            ]}
                            // description={["some", <strong>strong</strong>, "text"]}
                        />
                    </div>
                </Container>
            </div>
